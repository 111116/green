...
" usually indicating that the operation be repeated N times.\n"
"\n"
...
" *  <pagedown>, <space>, <RETURN> - Scroll down a whole screen.\n"
"\n"
" NAVIGATION\n"
" *  H, K - Go to previous page.\n"
" *  J, L - Go to next page.\n"
" *  g - Go to first page of document. ( Go to page N )\n"
" *  G - Go to last page of document. ( Go to page N )\n"
...
" *  n - Show next (N-th) page containing search keyword.\n"
"\n"
"For further help check out the man page\n";
